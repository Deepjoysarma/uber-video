...
const VehiclePanel = (props) => {
  return (
    <div>
      <h5 onClick={() => props.setVehiclePanel(false)} className='p-1 text-center w-[93%] absolute top-0'><i className='text-3xl text-gray-600 ri-arrow-down-wide-line'></i></h5>
        ...
        <div onClick={()=>{
          ...
          <h2 className='font-semibold text-lg'>₹63</h2>
        </div>
        ...
        <div onClick={()=>{
          ...
          <h2 className='font-semibold text-lg'>₹108</h2>
        </div>
    </div>
  )
}
